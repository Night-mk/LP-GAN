...
"""转置卷积类Deconv"""
class Deconv(Module):
    def __init__(self, in_channels, out_channels, filter_size, zero_padding, stride, method='SAME', bias_required=True):
    ...
    def forward(self, input_array):
        ...
        for i in range(0, self.batchsize):
            ...
            # print('Deconv input_col_i.shape: \n',input_col_i.shape)
            if self.bias_required:
